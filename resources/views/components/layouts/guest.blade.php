...
{{-- Controles flotantes (idioma + tema) --}}
<div class="fixed top-4 right-4 z-50 flex items-center gap-2">
    ...
    <div class="flex items-center rounded-xl overflow-hidden"
        ...
        <a href="{{ route('locale.switch', 'es') }}"
           class="inline-flex items-center justify-center w-9 h-9 text-xs font-semibold cursor-pointer transition-all duration-200"
           style="color: {{ $currentLocale === 'es' ? 'var(--ui-content)' : 'var(--ui-content-subtle)' }}; {{ $currentLocale === 'es' ? 'background: var(--auth-link-bg-hover);' : '' }}"
           title="Español">
            ES
        </a>
        <div class="w-px h-5" style="background: var(--auth-link-border);"></div>
        <a href="{{ route('locale.switch', 'en') }}"
           class="inline-flex items-center justify-center w-9 h-9 text-xs font-semibold cursor-pointer transition-all duration-200"
           style="color: {{ $currentLocale === 'en' ? 'var(--ui-content)' : 'var(--ui-content-subtle)' }}; {{ $currentLocale === 'en' ? 'background: var(--auth-link-bg-hover);' : '' }}"
           title="English">
            EN
        </a>
    </div>
