<div>
    ...
    <div class="mb-7 text-center">
        <h1 class="text-2xl font-bold mb-1.5" style="color: var(--ui-content);">{{ __('public.reset_title') }}</h1>
        <p class="text-sm" style="color: var(--ui-content-muted);">{{ __('public.reset_subtitle') }}</p>
    </div>
