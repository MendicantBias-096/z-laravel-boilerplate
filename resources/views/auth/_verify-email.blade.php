<div>
    ...
    <div class="mb-7 text-center">
        ...
        <h1 class="text-2xl font-bold mb-1.5" style="color: var(--ui-content);">{{ __('public.verify_email_title') }}</h1>
        <p class="text-sm" style="color: var(--ui-content-muted);">{{ __('public.verify_email_subtitle') }}</p>
    </div>

    @if ($sent)
        <div class="mb-4 rounded-xl p-4 text-sm text-center"
             style="background: rgba(34,197,94,0.1); color: #16a34a; border: 1px solid rgba(34,197,94,0.2);">
            {{ __('public.verify_email_sent') }}
        </div>
    @endif
