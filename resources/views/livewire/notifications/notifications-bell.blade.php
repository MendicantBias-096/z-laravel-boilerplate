...
>
    ...
    >
        ...
        <div class="flex items-center justify-between border-b border-line px-4 py-3">
            <h3 class="text-sm font-semibold text-content">{{ __('notifications.title') }}</h3>
            @if ($unreadCount > 0)
                <button
                    type="button"
        ...
        >
            ...
            @empty
                <div class="flex flex-col items-center justify-center py-10">
                    ...
                    <p class="text-xs text-content-muted">{{ __('notifications.empty_all') }}</p>
                </div>
            @endforelse
        </div>
        ...
        <div class="border-t border-line">
            <a
                href="{{ route('general.notifications.index') }}"
                wire:navigate
                @click="open = false"
