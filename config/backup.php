...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            /*
             * Dónde se guarda. `local` por defecto porque es lo único que
             * existe seguro en cualquier despliegue, pero un backup que vive
             * en el mismo disco que la base de datos no sobrevive al incidente
             * que lo justifica: en producción esto apunta a `s3` o similar.
             */
    ...
    'notifications' => [
        'notifications' => [
            // Solo lo que exige actuar. Avisar de cada backup correcto
            // enseña a ignorar el aviso, y el que importa —el que falló—
            // llega al mismo buzón donde ya nadie mira.
