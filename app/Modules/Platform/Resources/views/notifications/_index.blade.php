<div>
    ...
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex gap-1 rounded-lg border border-line bg-panel p-1">
            ...
            >
                {{ __('platform::notifications.tab_unread') }}
            </button>
            <button
                type="button"
            ...
            >
                {{ __('platform::notifications.tab_all') }}
            </button>
        </div>
        ...
        @if ($tab === 'unread' && $notifications->total() > 0)
            <button
                ...
                wire:confirm="{{ __('platform::notifications.confirm_mark_all') }}"
        ...
        @if ($notifications->hasPages())
            <div class="mt-4 flex flex-wrap items-center justify-between gap-3">
                <div class="flex items-center gap-1.5 text-sm text-content-muted">
                    ...
                    {{ __('platform::table.results') }} {{ $notifications->total() }}
                </div>
    ...
    @else
        ...
        <div class="flex flex-col items-center justify-center rounded-lg border border-line bg-panel py-16">
            ...
            <p class="text-sm font-medium text-content-muted">
                {{ $tab === 'unread' ? __('platform::notifications.empty_unread') : __('platform::notifications.empty_all') }}
            </p>
        </div>
    @endif
