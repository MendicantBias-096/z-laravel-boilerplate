<div class="relative min-h-screen overflow-hidden font-['Inter',sans-serif]"
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                ...
                <div class="p-8 rounded-2xl"
                    ...
                    <h3 class="font-bold text-xl mb-3" style="color: var(--ui-content);">{{ __('platform::public.about_mission_title') }}</h3>
                ...
                <div class="p-8 rounded-2xl"
                    ...
                    <h3 class="font-bold text-xl mb-3" style="color: var(--ui-content);">{{ __('platform::public.about_vision_title') }}</h3>
                    <p class="text-sm leading-relaxed" style="color: var(--ui-content-muted);">
            ...
            <div class="text-center mb-12">
                <p class="text-xs font-semibold tracking-[0.2em] uppercase mb-3" style="color:#f53003;">{{ __('platform::public.about_values_label') }}</p>
                <h2 class="text-3xl font-bold" style="color: var(--ui-content);">{{ __('platform::public.about_values_title') }}</h2>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                @foreach([
                    ['icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',    'label' => __('platform::public.about_val_quality'),   'color' => '#f97055', 'bg' => 'rgba(245,48,3,0.1)',     'bd' => 'rgba(245,48,3,0.2)'],
                    ['icon' => 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', 'label' => __('platform::public.about_val_security'), 'color' => '#64dcff', 'bg' => 'rgba(100,220,255,0.08)', 'bd' => 'rgba(100,220,255,0.18)'],
                    ['icon' => 'M13 10V3L4 14h7v7l9-11h-7z',                         'label' => __('platform::public.about_val_perf'),     'color' => '#a78bfa', 'bg' => 'rgba(167,139,250,0.08)', 'bd' => 'rgba(167,139,250,0.18)'],
                    ['icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', 'label' => __('platform::public.about_val_community'), 'color' => '#34d399', 'bg' => 'rgba(52,211,153,0.08)', 'bd' => 'rgba(52,211,153,0.18)'],
                ] as $v)
    ...
    <section class="relative z-10 py-20 px-8 text-center"
        ...
        <div class="max-w-xl mx-auto">
            <h2 class="text-2xl lg:text-3xl font-bold mb-4" style="color: var(--ui-content);">{{ __('platform::public.about_cta_title') }}</h2>
            ...
            <div class="flex items-center justify-center gap-3">
                <a href="{{ route('register') }}"
                   ...
                   onmouseout="this.style.boxShadow='0 4px 24px rgba(245,48,3,0.35)';this.style.transform='translateY(0)';">
                    {{ __('platform::public.about_cta_register') }}
                </a>
                <a href="{{ route('login') }}"
                   ...
                   onmouseout="this.style.background='var(--auth-link-bg)';this.style.borderColor='var(--auth-link-border)';this.style.color='var(--ui-content-muted)';">
                    {{ __('platform::public.about_cta_login') }}
                </a>
            </div>
        </div>
    </section>
