            ...
            <div class="flex items-center gap-4 min-w-0">
                <div class="shrink-0">
                    @if ($logo)
                        ...
                        >
                    @elseif (\App\Modules\Platform\Models\Setting::get('logo_path'))
                        <img
                            src="{{ Storage::disk('public')->url(\App\Modules\Platform\Models\Setting::get('logo_path')) }}"
                            alt="Logo"
                            class="h-16 w-16 rounded-xl object-cover ring-2 ring-line"
                        >
                    @else
                ...
                <div class="shrink-0">
                    @if ($favicon)
                        <img
                            ...
                            class="h-16 w-16 rounded-xl object-cover ring-2 ring-line"
                        >
                    @elseif (\App\Modules\Platform\Models\Setting::get('favicon_path'))
                        <img
                            src="{{ Storage::disk('public')->url(\App\Modules\Platform\Models\Setting::get('favicon_path')) }}"
                            alt="Favicon"
                            class="h-16 w-16 rounded-xl object-cover ring-2 ring-line"
                        >
                    @else
