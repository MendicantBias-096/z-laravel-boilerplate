...
namespace App\Modules\Platform\Livewire\Docs;
...
class Index extends Component
{
    ...
    {
        return $this->documents()[$this->doc]['title'] ?? __('platform::docs.not_found');
    }

    public function render(): Factory|View
    {
        return view('platform::docs._index');
    }
        ...
        return (string) preg_replace_callback(
            ...
            function (array $match) use ($copy, $done): string {
                ...
                return '<div class="code" x-data="{ copied: false }">'
                    ...
                    .' :aria-label="copied ? \''.__('platform::docs.copied').'\' : \''.__('platform::docs.copy').'\'"'
