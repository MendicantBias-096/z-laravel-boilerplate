<div>
    ...
    <div class="mb-7 text-center">
        <h1 class="text-2xl font-bold mb-1.5" style="color: var(--ui-content);">{{ __('platform::public.forgot_title') }}</h1>
        <p class="text-sm" style="color: var(--ui-content-muted);">{{ __('platform::public.forgot_subtitle') }}</p>
    </div>
    ...
    @if ($linkSent)
        ...
        <div class="rounded-xl p-4 mb-6 text-center"
            ...
            <div class="flex items-center justify-center gap-2 mb-1">
                ...
                <span class="text-sm font-semibold text-success">{{ __('access::passwords.sent') }}</span>
            </div>
        ...
        <button type="button"
            ...
            <span wire:loading.class="opacity-0 -translate-y-2"
                ...
                {{ __('platform::public.forgot_button') }}
            </span>
            <span wire:loading.class.remove="opacity-0 translate-y-2"
                ...
                {{ __('platform::public.forgot_sending') }}
            </span>
        </button>
    @else
    ...
    <a href="{{ route('login') }}" wire:navigate
       ...
       onmouseout="this.style.background='var(--auth-link-bg)';this.style.borderColor='var(--auth-link-border)';this.style.color='var(--ui-content-muted)';">
        ...
        {{ __('platform::public.forgot_back_login') }}
    </a>
</div>
