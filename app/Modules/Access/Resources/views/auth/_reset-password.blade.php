<div>
    ...
    <div class="mb-7 text-center">
        <h1 class="text-2xl font-bold mb-1.5" style="color: var(--ui-content);">{{ __('platform::public.reset_title') }}</h1>
        <p class="text-sm" style="color: var(--ui-content-muted);">{{ __('platform::public.reset_subtitle') }}</p>
    </div>
    ...
    <form wire:submit="resetPassword" class="flex flex-col gap-4" novalidate>
        ...
        <button type="submit"
            ...
            <span wire:loading.class="opacity-0 -translate-y-2"
                ...
                {{ __('platform::public.reset_button') }}
            </span>
            <span wire:loading.class.remove="opacity-0 translate-y-2"
                ...
                {{ __('platform::public.reset_resetting') }}
            </span>
        </button>
