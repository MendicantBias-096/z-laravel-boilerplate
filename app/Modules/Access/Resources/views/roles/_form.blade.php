            ...
            <x-ts-card>
                <x-slot:header>
                    <div class="py-3" style="padding-left: 14px;">
                        <h3 class="text-sm font-semibold text-content">{{ __('platform::app.role_permissions') }}</h3>
                        <p class="text-xs text-content-muted">{{ __('platform::app.role_permissions_desc') }}</p>
                    </div>
                </x-slot:header>
                ...
                <x-slot:footer>
                    <div class="flex items-center justify-end gap-3">
                        <a href="{{ route('access.roles.index') }}" wire:navigate
